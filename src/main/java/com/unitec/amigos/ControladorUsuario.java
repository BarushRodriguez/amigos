...
public class ControladorUsuario {
    ...
    //Aquí viene ya el uso de la inversion de control
    @Autowired RepositorioUsuario repoUsuario;


    //Implementamos el codigo para guardar un archivo en MongoDB
    @PostMapping("/usuario")
    ...
    public Estatus actualizar (@RequestBody String json) throws Exception{
        //Primero verificamos que exista, por lo tanto primero lo buscamos
        ObjectMapper mapper = new ObjectMapper();
        Usuario u=mapper.readValue(json, Usuario.class);
